...
func select_district(district: int):
	get_child(district).get_child(1).modulate = Color(0.75,0.75,0.75,0.75)
func deselect_district(district: int):
	get_child(district).get_child(1).modulate = Color(1,1,1,0.5)
